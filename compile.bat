...
gcc -c -g -Wall -m32 src/long_mode_os/kernel/*.c asm.o -o cdiso/kernel.o -nostdlib -ffreestanding -mno-red-zone -fno-exceptions -nodefaultlibs -fno-builtin -fno-pic -fno-pie || GOTO end
